...
\begin{figure}[ht!]
     \begin{center}
        \subfigure[]{
            \label{meth:first}
            \includegraphics[width=0.47\textwidth]{images/methK562-2}
        }
        \subfigure[]{
           \label{meth:second}
           \includegraphics[width=0.47\textwidth]{images/methH1hESC-2}
        }
    \end{center}
